(function(){
var HUBS=window.QL_INDEX||[],PARTS=null,partsPending=false;
...
function loadParts(cb){
  ...
  s.onload=function(){PARTS=window.QL_PARTS||[];partsPending=false;cb();};
...
if(box&&out){
  ...
  var render=function(){
    ...
    if(!q){out.innerHTML='<article class="card"><h3>Nhập mã hàng hoặc model để tra</h3>'+
      '<p>Ví dụ: QTG50L-3-24, ST45L-BZ, QWCD50, SNELR.</p></article>';return;}
